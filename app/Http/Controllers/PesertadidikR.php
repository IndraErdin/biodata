...
class PesertadidikR extends Controller
{
    ...
    public function index()
    {
        ...
        // $pesertaM = PesertadidikM::all();
        $pesertaMO = PesertadidikMO::search(request('search'))->paginate(10);
        $vcari = request('search');
        return view('pesertadidik', compact('pesertaMO', 'vcari'));
    }
    ...
    public function store(Request $request)
    {
        ...
        PesertadidikMO::create($request->post());
    ...
    {
        $peserta = PesertadidikMO::find ($id);
    ...
    public function update(Request $request, $id)
    {
        ...
        PesertadidikMO::where('id', $id)->update($data);
    ...
    {
        PesertadidikMO::where('id', $id)->delete();
